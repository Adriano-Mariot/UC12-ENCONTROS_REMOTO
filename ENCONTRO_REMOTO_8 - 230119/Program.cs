                            ...
                            switch (opcaoPf)
                            {
                                ...
                                case "1":
                                    ...
                                    using (StreamWriter sw = new StreamWriter ($"{pf1.Nome}.txt"))
                                    {
                                        ...
                                        sw.WriteLine($"Rendimentos Anual= {pf1.Rendimento}");
                                        sw.WriteLine($"Rendimentos Liquido = {metodosPf.PagarImposto(pf1.Rendimento)}");
                                        sw.WriteLine($"Idade = {pf1.DataNaceimento.ToShortDateString()}");
                                        sw.WriteLine(metodosPf.ValidarDataNascimento (pf1.DataNaceimento) ? "Maior de Idade : Sim! " : "Maior de Idade : Não! ");
                                        sw.WriteLine($"Logradouro = {pf1.Endereco.Logradoura},{pf1.Endereco.Numero}");                                      
                                        sw.WriteLine((pf1.Endereco.Comercial) ? "Endereço comercial? : Sim! " : "Endereço comercial? : Não! ");
                                    }                           
                                ...
                                case "2":
                                    ...
                                    using (StreamReader sr = new StreamReader("Pessoa_Fisica.txt"))
                                    {
                                        string linha;
    ...
    =======================================
                            ...
                            switch (opcaoPj)
                            {
                                ...
                                case "2":
                                    ...
                                    List<PessoaJuridica> listaexibirPj=metodosPj.LerArquivo(); 

                                    foreach (PessoaJuridica pessoaJu in listaexibirPj)
                                    {
                                        Console.WriteLine($"\nRepresentante : {pessoaJu.Nome}");
                                        Console.WriteLine($"CNPJ : {pessoaJu.Cnpj}");
                                        Console.WriteLine($"Razão Social : {pessoaJu.RazaoSocial}");
                                        Console.WriteLine($"Nome Fantasia : {pessoaJu.Fantasia}");
                                        // Console.WriteLine($"Logradouro = {pessoaJu.Endereco.Logradoura}");  
